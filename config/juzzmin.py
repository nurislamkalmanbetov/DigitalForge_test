JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        "nedvijimost": "fas fa-home",
        "nedvijimost.Apartment": "fas fa-file",
        "nedvijimost.User": "fas fa-users",
        "nedvijimost.SalesManager": "fas fa-user",
        "nedvijimost.HousingObject":"fas fa-book",
